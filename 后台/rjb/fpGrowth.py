...
def createTree(dataSet, minSup=1):  # create FP-tree from dataset but don't mine
    ...
    for trans in dataSet:  # first pass counts frequency of occuranc
        for item in trans:
...
if __name__ == '__main__':
    initSet = loadSimpDat()
    tpSet = createInitSet(initSet)
    myFPtree, myHeaderTab = createTree(tpSet, 3)
    myFrequentList = []
    mineTree(myFPtree, myHeaderTab, 3, set([]), myFrequentList)
    print(myFrequentList)